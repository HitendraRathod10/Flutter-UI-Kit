...
class CommercialResultScreen extends StatefulWidget {
  const CommercialResultScreen({Key? key}) : super(key: key);

  @override
  State<CommercialResultScreen> createState() => _CommercialResultScreenState();
}

class _CommercialResultScreenState extends State<CommercialResultScreen> {
