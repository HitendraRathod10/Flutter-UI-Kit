...
class ResidentialResultScreen extends StatefulWidget {
  const ResidentialResultScreen({Key? key}) : super(key: key);

  @override
  State<ResidentialResultScreen> createState() => _ResidentialResultScreenState();
}

class _ResidentialResultScreenState extends State<ResidentialResultScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title:
          Text("Residential Plots/Land", style: Theme.of(context).textTheme.titleLarge?.copyWith(),),
